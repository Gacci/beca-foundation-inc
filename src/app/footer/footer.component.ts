  ...
  template: `
    <footer class="text-center lg:text-left bg-gray-100 text-gray-600">
      ...
      >
        ...
        <div class="flex justify-center">
          <a
            ...
            href="https://www.facebook.com/profile.php?id=100057487959992"
          >
            <svg
              class="w-4 h-4"
              fill="currentColor"
      ...
      <div class="mx-6 py-10 text-center md:text-left">
        <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div class="md:col-span-2">
            ...
            <p>
              Our mission is to encourage and empower aspiring Latino students
              to pursue higher education through financi
            </p>
          </div>
          ...
          <div class="">
            ...
            <p class="flex items-center justify-center md:justify-start mb-4">
              ...
              Escondido, CA, United States, California
            </p>
            <p class="flex items-center justify-center md:justify-start mb-4">
              <svg
                aria-hidden="true"
      ...
      <div class="text-center p-6 bg-gray-200">
        <span>© {{ datetime | date: 'y' }} Copyright: </span>
        <a
